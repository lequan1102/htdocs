...
return [
    ...
    */
    ...
    'primary_color' => '#2d353d',

    'show_dev_tips' => true, // Hiển thị mẹo phát triển "Cách sử dụng:" trong Menu và Cài đặt

    // Tại đây bạn có thể chỉ định các tài sản bổ sung mà bạn muốn được đưa vào master.blade
    'additional_css' => [
        //'css/custom.css',
    ],

    'additional_js' => [
         '/public/form_fields/ckeditor/ckeditor.js',
         '/public/form_fields/ckfinder/ckfinder.js',
         '/public/form_fields/input_ckeditor.js',
    ],
