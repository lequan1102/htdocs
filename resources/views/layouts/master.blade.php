...
<!--===============================================================================================-->
<title><?php if(isset($article) && ($article->title != '')){ echo $article->title; } else { echo setting('site.title'); }?></title>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="{{ url('/') }}" class="logo">
						<img src="{{ asset('public/storage') }}/{{ setting('site.logo') }}" alt="IMG-LOGO">
					</a>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" id="total_cart" data-notify="{{ Cart::getContent()->count() }}">
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<a id="js-remove-cart" data-productid="{{ $row->id }}" href="javascript:void(0)">
							<div class="header-cart-item-img">
								<img src="{{ asset('storage/app/public') }}/{{ $row->model->image }}">
							</div>
						</a>
	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
				</p>
			</div>
		</div>
	</footer>
...
<!--===============================================================================================-->
    ...
    $.ajax({
      ...
      success: function (response) {
        $('#total_cart').attr('data-notify',response.total_cart);
        toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
