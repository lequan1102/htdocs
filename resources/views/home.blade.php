          ...
          <div class="block2">
            ...
            <div class="block2-txt flex-w flex-t p-t-14">
              <div class="block2-txt-child1 flex-col-l ">
                <a href="{{ route('article_product',['slug' => $product->slug]) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                  {{ $product->title }}
                </a>
              ...
              <div class="block2-txt-child2 flex-r p-t-3">
                <a href="{{ route('article_product',['slug' => $product->slug]) }}" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
